...
<nav class="header">
  ...
  <div class="btn">
    ...
    <?php else: ?>
      <a style="background: #d300ff;"href="register.php" class="signup-btn">Signup</a>
      <a style="background: #d300ff;" href="login.php" class="login-btn">Login</a>
    <?php endif; ?>
  </div>
</nav>
    ...
    <div id="product-modal" class="prodmodal">
      ...
      <h2>Liquid Network</h2>
       ...
       <a style="color: rgb(255, 255, 255); margin-top: 5vh;" href="pricing.html" class="product-btn">
        ...
        <a style="color: rgb(255, 255, 255);" href="pricing.html" class="product-btn">
          Get Started
      </a>
      </div>
        <div class="core">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide2">
        <div class="txt">
          ...
          <div class="card1">
            <img class="bitcoin-img"src="ics/bitcoin.png">
